...
4. Seleccionar `Comportamiento_del_Usuario_Web.ipynb`
...
jupyter notebook Comportamiento_del_Usuario_Web.ipynb
```
...
│
├── Comportamiento_del_Usuario_Web.ipynb   ← Notebook principal
